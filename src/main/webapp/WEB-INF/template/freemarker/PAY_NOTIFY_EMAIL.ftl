                    ...
                    <table style="margin-top: 5px;" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="background: url(http://img.iyoubox.com/GetFileByCode/D88F61341715990677B10F3D12DDD1DB) repeat-y left center;
                                ...
                                <p class="fontstyle_2" style="text-indent: 2em; font-size: 16px; line-height: 29px;
                                    color: #333333; margin: 0 10px;">
                                        <span>您在美月淘预约订购的${reserveDeliveryTime?string("yyyy年MM月dd日")}发货的商品，我们已经为您备货完毕，提醒您及时付款。订单号:${boxOrder.orderSeq}
                                ...
                                <div>
                                        <table width="620" border="0" cellpadding="0" cellspacing="0" class="goods_yuding" style="margin-top: 0px;">
                                            <tbody><tr>
                                                <td width="150" height="25" align="left" valign="middle" bgcolor="#f7f7f7">待付款商品
                                                </td>
												 <td width="250" height="25" align="right" valign="middle" bgcolor="#f7f7f7">
                                                    &nbsp;
                                                </td>
												 <td width="120" height="25" align="right" valign="middle" bgcolor="#f7f7f7">
                                                   
                                                </td>
                                                <td width="150" height="25" align="right" valign="middle" bgcolor="#f7f7f7">
                                                     总计：￥${boxOrderDetail.actualAmount?default(0.00)} 元
                                                </td>
                                            </tr>
											<#list boxOrderDetailCommodities as item>
                                            <tr>
                                                <td >
												...
												<td > 
													 <p style=" text-align: center; color: #666; font-size: 14px; overflow: hidden;
                                                                    text-indent: 0;">
                                                                  	 ￥${item.actualAmount?default(0.00)}
                                                </td>
											 </tr>
											 </#list>
                                        </tbody></table>
